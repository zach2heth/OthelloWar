...
public class War{
  ...
  * Put this method in a while-loop in the main class. Pass in Info
  **********************************************/
      ...
      switch(numPlayers){
          case 2:
              if(turnCycle % 2 == 1){
                 ...
                 play2Turn = false; //play2.updateUnitList();
              }
              else{
...
//                    +" play3Turn: "+play3Turn+ " play4Turn: "+play4Turn);
    ...
    **********************************************/
    ...
    /*********************************************
    * Returns the player who are not having their turn
    **********************************************
    public SLL<Player> otherPlayers(){
      SLL<Player> other = new SLL<Player>();
      if(play1Turn){
          other.add(play2);
          if(numPlayers == 3) other.add(play3);
          if(numPlayers == 4) other.add(play4);
      }
      else if(play2Turn){
          other.add(play1);
          if(numPlayers == 3) other.add(play3);
